...
def receiveBooking():
    ...
    channelqueue = channel.queue_declare(queue="mentor", durable=True) # 'durable' makes the queue survive broker restarts so that the messages in it survive broker restarts too
...
# # ERROR HANDLING WILL BE IGNORED FOR NOW
