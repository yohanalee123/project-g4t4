...
1) course.py via Docker* (refer to next section for running with Docker)
2) user.py
3) chat.py
4) mentor.py
5) booking_reply.py
...
*Running the course microservice with Docker:
...
Before going to Step 2, make sure you have the user "is213" created for your phpMyAdmin.
